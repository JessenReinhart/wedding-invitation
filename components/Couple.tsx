...
export const Couple: React.FC = () => {
    return (
        <section id="couple" className="relative w-full bg-ivory py-32 px-6 md:px-12 overflow-hidden flex flex-col justify-center">
            ...
            <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 relative z-10 items-start">
                ...
                >
                    ...
                    <p className="font-serif italic text-xl text-wine-dark/80">Putri dari Almarhum Tommy Sitorus dan Ibu Sri Djuhariah</p>
                ...
                >
                    ...
                    <div className="w-12 h-px bg-wine/30 my-6"></div>
                    <p className="font-serif italic text-xl text-wine-dark/80">Putra dari Almarhum Sugiarto Seno dan Yessy Wahyuni</p>
